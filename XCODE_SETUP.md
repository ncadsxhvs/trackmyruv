...
1. **Open Info.plist:**
   - In Xcode Navigator, find and click on the **Info.plist** file
   - Or: Select project → target → Info tab

2. **Add URL Types:**
   - Right-click in the Info.plist editor
   - Select **"Add Row"**
   - Type: **"URL types"** (or find "URL types" if it already exists)
   - Click the disclosure triangle to expand it

3. **Add Item 0 (if not present):**
...
4. **Add URL Schemes:**
   ...
   - Set **"Item 0"** value to your **reversed client ID**
